...
/**
 * This {@link PixelContainer} class is just a wrapper for the pixel array, with additional metadata for (x, y) -> index
...
public class PixelContainer {
    ...
    public PixelContainer(final int[] pixels, final int width, final int height) {
        this.pixels = pixels;
        this.width = width;
        this.height = height;
    }
